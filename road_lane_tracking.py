...
cv2.imwrite(os.path.join('test_images_output/' , 'solidWhiteCurve_grayscale.jpg'), grayimg1)
...
imshape = img1.shape
vertices = np.array([[(0,imshape[0]),(457, 320), (490, 315), (imshape[1],imshape[0])]], dtype=np.int32)
...
cv2.imwrite(os.path.join('test_images_output/' , 'solidWhiteCurve_segment.jpg'), cv2.cvtColor(final_seg_img1, cv2.COLOR_RGB2BGR))
cv2.imwrite(os.path.join('test_images_output/' , 'solidWhiteCurve_thirdpass.jpg'), cv2.cvtColor(final_con_img1, cv2.COLOR_RGB2BGR))
'''
